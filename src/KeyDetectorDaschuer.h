...
#ifndef KEY_DETECTOR_DASCHUER_H
#define KEY_DETECTOR_DASCHUER_H
...
class KeyDetectorDaschuer : public KeyDetectorIface
{
public:
    struct Config {
        double sampleRate;
    ...
    KeyDetectorDaschuer(Config config);

    virtual ~KeyDetectorDaschuer();
